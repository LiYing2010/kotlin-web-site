...
type: doc
layout: reference
title: "Kotlin 跨平台程序的 Gradle DSL 参考文档"
---

# Kotlin 跨平台程序的 Gradle DSL 参考文档

> 跨平台项目还处于 [Alpha](evolution/components-stability.html) 阶段.
...
详情请参见 [如何在 JVM 编译任务中包含 Java 源代码](mpp-configure-compilations.html#include-java-sources-in-jvm-compilations).
...
详情请参见 [配置 Kotlin/JS 项目](js-project-setup.html).
...
详情请参见 [针对 Android 的编译](mpp-configure-compilations.html#compilation-for-android).
...
详情请参见 [配置依赖项](using-gradle.html#configuring-dependencies).
