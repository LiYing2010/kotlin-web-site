...
要在一个库中添加依赖项, 需要在你的 [Gradle](../gradle.html) 构建脚本中的
[`dependencies`](mpp-dsl-reference.html#dependencies)
代码段内, 设置必要 [类型](../gradle.html#dependency-types) 的依赖项 (比如, `implementation`).
