...
layout: reference
category: "Native"
title: "Kotlin/Native 中的不变性(Immutability)与并发(Concurrency)"
---

# Kotlin/Native 中的不变性(Immutability)与并发(Concurrency)
...
将这些机制结合在一起, 可以在跨平台项目中实现跨平台的代码重用, 实现非常自然的无并发竞争(race-free)编程.
