...
[worker 示例程序](https://github.com/JetBrains/kotlin-native/tree/master/samples/workers).
...
如果对于某个任务 worker 机制还不足以完成任务, 这个功能与 [原生的共享内存(raw memory sharing)](#shared) 结合在一起,
