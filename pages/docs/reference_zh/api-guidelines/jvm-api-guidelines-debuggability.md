...
> 使用 [数据类](../data-classes.html) 看起来好像很不错, 因为它们自动带有 `toString()` 方法.
...
<img src="/assets/docs/images/api-guidelines/debug-person-builder-improved.png" alt="PersonBuilder 改善后的调试结果" width="700"/>
