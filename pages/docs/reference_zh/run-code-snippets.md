...
<img src="/assets/docs/images/run-code-snippets/playground-share.png" alt="Playground: 共享代码" width="700"/>
...
<img src="/assets/docs/images/run-code-snippets/ki-shell-load.png" alt="ki shell 装载文件" width="700"/>
