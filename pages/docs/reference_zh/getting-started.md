...
* 如果 Kotlin 是你学习的第一种编程语言, 我们建议从书籍 [Atomic Kotlin](https://www.atomickotlin.com/atomickotlin/) 开始阅读,
  或在 JetBrains 学院参加免费的 [Kotlin 基础课程](https://hyperskill.org/tracks/18).
...
<div markdown="1" class="tabs">
  <ul>
    <li><a href="#tabs-Backend-app">后端应用程序</a></li>
    <li><a href="#tabs-Cross-platform-mobile-app">跨平台移动应用程序</a></li>
    <li><a href="#tabs-Frontend-web-app">前端 Web 应用程序</a></li>
    <li><a href="#tabs-Android-app">Android 应用程序</a></li>
    <li><a href="#tabs-Multiplatform-library">跨平台库</a></li>
  </ul>


<div markdown="1" id="tabs-Backend-app">

下面是开发 Kotlin 服务端应用程序的开始步骤.

1. **安装 [IntelliJ IDEA 的最新版本](https://www.jetbrains.com/idea/download/index.html).**
...
3. **在你的应用程序中使用 Kotlin 和第三方库**. 详情请参见 [向你的项目添加库和工具依赖项](gradle.html#configuring-dependencies).
...
<div markdown="1" id="tabs-Cross-platform-mobile-app">

在这里你将会学习如何使用[Kotlin 跨平台应用程序程序 (KMM)](https://kotlinlang.org/lp/mobile/)来开发并改进你的跨平台移动应用程序 .

1. **[为跨平台开发设置环境](kmm/kmm-setup.html).**

2. **创建你的第一个 KMM 应用程序:**

   * 要从零开始创建, 可以 [使用 IntelliJ IDEA 的项目向导创建一个基本的 KMM 应用程序](kmm/kmm-create-first-app.html).
   * 如果你有已经存在的 Android 应用程序, 并且希望将它变为跨平台应用程序, 请阅读教程 [让你的 Android 应用程序在 iOS 上运行](kmm/kmm-integrate-in-existing-app.html).
   * 如果你想看看比较真实的示例程序, 请 clone 并查看既有的项目,
   ...
   或者 [KMM 示例](kmm/kmm-samples.html) 中的示例.

3. **使用大量的跨平台库** 在共用模块中实现需要的业务逻辑. 详情请参见 [添加依赖项](kmm/kmm-add-dependencies.html).
   ...
   | 协程(Coroutine) |  [文档](kmm/kmm-concurrency-overview.html) 与 [示例](kmm/kmm-concurrency-and-coroutines.html).|
   | 日期与时间 | [文档](https://github.com/Kotlin/kotlinx-datetime#readme).|
   | SQLDelight | 第三方库. [文档](https://cashapp.github.io/sqldelight/) 与 [示例](kmm/kmm-configure-sqldelight-for-data-storage.html).|
...
4. **关于 KMM 的更多资料:**
   * 关于 [Kotlin 跨平台开发](mpp/mpp-intro.html).
   * 阅读 [GitHub 上的 KMM 示例程序](kmm/kmm-samples.html).
   * [创建并发布跨平台的库](mpp/mpp-create-lib.html).
   * 使用 KMM 的真实案例:
   [Netflix](https://netflixtechblog.com/netflix-android-and-ios-studio-apps-kotlin-multiplatform-d6d4d8d25d23),
   [VWWare](https://kotlinlang.org/lp/mobile/case-studies/vmware/),
...
<div markdown="1" id="tabs-Frontend-web-app">
...
2. **创建你的第一个前端 Web 应用程序:**

   * 要从零开始创建, 可以 [使用 IntelliJ IDEA 的项目向导创建一个基本的浏览器应用程序](js/js-project-setup.html).
   * 如果想要阅读更加复杂的示例, 请阅读动手教程 [使用 React 和 Kotlin/JS 创建 Web 应用程序](https://play.kotlinlang.org/hands-on/Building%20Web%20Applications%20with%20React%20and%20Kotlin%20JS/01_Introduction).
   这个教程包含了一个示例项目, 它可以当作一个很好的起点来开发你自己的项目, 其中还包含了很多有用的代码片段和模板.
   * 关于如何使用 Kotlin/JS 的更多信息请参见 [Kotlin/JS 示例](js/js-samples.html).

3. **在你的应用程序中使用.** 详情请参加 [添加依赖项](js/js-project-setup.html#dependencies).
...
<div markdown="1" id="tabs-Android-app">
...
<div markdown="1" id="tabs-Multiplatform-library">
...
2. **创建跨平台库:**
   ...
   * 要从零开始创建, 可以 [创建一个基本的项目](mpp/mpp-create-lib.html).
   * 如果想要阅读更加复杂的示例, 请阅读教程 [创建并发布跨平台的库](mpp/multiplatform-library.html).
    这个教程介绍如何创建跨平台的库, 用于 JVM, JS, 和原生(Native)平台, 如何测试, 以及如何发布到本地的 Maven 仓库.
   * 通过 [这个动手教程](https://play.kotlinlang.org/hands-on/Full%20Stack%20Web%20App%20with%20Kotlin%20Multiplatform/01_Introduction),
    学习如何创建完整的 Web 应用程序.

3. **在你的应用程序中使用库.** 详情请参见 [添加库的依赖项](mpp/mpp-add-dependencies.html).

   |库|详情|
   |-------|-------|
   | Ktor |  [文档](https://ktor.io/docs/) 与 [示例](https://play.kotlinlang.org/hands-on/Full%20Stack%20Web%20App%20with%20Kotlin%20Multiplatform/03_A_Simple_API_Server).|
   | 序列化 |  [文档](serialization.html) 与 [示例](https://play.kotlinlang.org/hands-on/Full%20Stack%20Web%20App%20with%20Kotlin%20Multiplatform/01_Introduction).|
...
4. **关于 Kotlin 跨平台开发的更多资料:**

   * [Kotlin 跨平台程序开发](mpp/mpp-intro.html).
   * [Kotlin 跨平台程序支持的平台](mpp/mpp-supported-platforms.html).
   * [Kotlin 跨平台程序开发的益处](mpp/multiplatform.html).
