...
def get_nav_impl():
    with open(path.join(data_folder, "_nav_zh.yml")) as stream:
...
@app.route('/docs/diagnostics/experimental-coroutines/')
@app.route('/docs/reference_zh/coroutines.html')
def coroutines_redirect():
    return render_template('redirect.html', url=url_for('page', page_path='docs/reference_zh/coroutines-overview'))
...
@app.route('/docs/reference_zh/collections.html')
def collections_redirect():
    return render_template('redirect.html', url=url_for('page', page_path='/docs/reference_zh/collections-overview'))

@app.route('/docs/reference_zh/experimental.html')
def optin_redirect():
    return render_template('redirect.html', url=url_for('page', page_path='/docs/reference_zh/opt-in-requirements'))
...
@app.route('/docs/reference_zh/compatibility.html')
def compatibility_redirect():
    return render_template('redirect.html', url=url_for('page', page_path='/docs/reference_zh/evolution/components-stability'))
...
def api_page(page_path):
    print(" page_path = " + page_path + "; build_mode = " + str(build_mode))
