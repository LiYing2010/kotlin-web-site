...
垃圾收集器会使用 Instruments 中的 signposts 来报告暂停.
Signposts 允许在你的 App 中自定义 log, 因此你可以检查应用程序失去响应是不是由于 GC 暂停导致的.
...
5. 点击红色的记录按钮, 运行你的 App, 并开始记录 signpost 事件:
   ...
   ![使用 signposts 追踪 GC 暂停](native-gc-signposts.png){width=700}
