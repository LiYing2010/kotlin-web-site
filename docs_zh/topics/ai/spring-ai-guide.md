[//]: # (title: 教程 - 使用 Spring AI 创建一个回答问题的 Kotlin 应用程序)

<web-summary>学习如何使用 Spring AI 创建一个回答问题的 Kotlin 应用程序.</web-summary>
...
1. 下载并安装最新版本的 [IntelliJ IDEA](https://www.jetbrains.com/idea/download/), 并使用 Ultimate 订阅.
    ...
    > 如果你使用没有 Ultimate 订阅的 IntelliJ IDEA, 或者使用其它 IDE, 那么可以使用
...
在 Ultimate 订阅版的 IntelliJ IDEA 中创建一个新的 Spring Boot 项目:
...
* 在 [Kotlin AI 示例](https://github.com/Kotlin/Kotlin-AI-Examples/tree/master) 中查看其它 Spring AI 示例
* [使用 Spring Boot 和 Claude 创建一个任务管理应用程序](spring-boot-claude.md)
